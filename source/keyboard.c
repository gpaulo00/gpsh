...
void keyboard(touchPosition touch) {
    ...
    else if(touchInBox(touch, 64,151, 31,30)){printf_kb("dD€]");}
    ...
    else if(touchInBox(touch, 256,151, 31,30)){printf_kb("lL-£");}
    else if(touchInBox(touch, 288,151, 31,30)){printf_kb("ñÑ\\¥");}
    
    else if (touchInBox(touch, 0,182, 31,30)){ shift(); }
    else if (touchInBox(touch, 0,213, 62,30)){ abc(); }
    
    else if(touchInBox(touch, 32,182, 31,30)){printf_kb("zZ!·");}
    ...
    else if(touchInBox(touch, 224,151, 31,30)){printf_kb(",,..");}
